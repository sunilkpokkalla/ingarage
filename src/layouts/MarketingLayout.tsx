      ...
      <div className="fixed top-6 inset-x-0 z-50 flex justify-center px-4 pointer-events-none">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <Link to="/login" className="text-sm font-semibold text-zinc-600 hover:text-zinc-950 transition-colors px-4 py-2">
              Log In
            </Link>
            <Link 
              to="/register" 
      ...
      <footer className="border-t border-zinc-200 bg-white py-16 px-6 mt-20 relative z-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col gap-3 text-sm font-medium text-zinc-500">
            ...
            <Link to="/stories" className="hover:text-brand-500 transition-colors">Customer Stories</Link>
            <Link to="/integrations" className="hover:text-brand-500 transition-colors">Integrations</Link>
          ...
          <div className="flex flex-col gap-3 text-sm font-medium text-zinc-500">
            ...
            <Link to="/resources" className="hover:text-brand-500 transition-colors">Resources</Link>
