      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-zinc-900 rounded-3xl p-8 border border-zinc-800 shadow-sm flex flex-col">
            ...
            <Link href="/register" className="w-full py-3 px-4 border border-slate-300 rounded-full text-center font-medium text-zinc-300 hover:bg-zinc-950 transition-colors">
              Start Free Trial
            </Link>
          </div>
          ...
          <div className="bg-brand-600 rounded-3xl p-8 border border-brand-500 shadow-xl relative flex flex-col transform md:-translate-y-4">
            ...
            <Link href="/register" className="w-full py-3 px-4 bg-zinc-900 rounded-full text-center font-medium text-brand-700 hover:bg-brand-50 transition-colors shadow-lg">
              Start Free Trial
            </Link>
          </div>
